package com.examples.test.other;
...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        //从官网获取
        String appId = "2ub3ypZUAmCyKW9aYs7qYf3n1YceBQeVhU9k2YKGNKJ4";
        String sdkKey = "FZCViPb9Qe9dPHAUfKyh34PmKmzcZZHHzGEGM8sxSXHf";
        String activeKey = "086G-112L-21DT-GNNE";
