package com.tyg.test;

import com.examples.test.algorithm.*;
...
public class ArraySortTest {
    ...
    public void quickSort() throws Exception {
        ...
        assertArrayEquals(sortedArray, sort);
        System.out.println("sort before = " + Arrays.toString(array));
        System.out.println("sort after = " + Arrays.toString(sort));
        System.out.println("sort right = " + Arrays.toString(sortedArray));
    }
